...
이 과정에서 JWT에 값을 넣어주어서 반환할 때 사용할수 있는데 토큰의 subject, id, username 같은 값을 넣고
서버의 비밀키로 서명하여 토큰을 생성합니다.
...
# 7. 결론
스프링 시큐리티를 통하여 특히 JWT를 이용하는 기본적인 방법을 정리해 보았습니다. 아직도 어렵고... 필터는 많기 때문에
